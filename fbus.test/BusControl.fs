...
let ``Test bus control`` () =
    ...
    serializeCalls |> should equal 4 // 1 publish, 1 reply, 1 send, 1 reply
    publishCalls |> should equal 1 // 1 publish
    resolveCalls |> should equal 4 // 1 publish, 1 reply, 1 send, 1 reply
    deserializeCalls |> should equal 4 // 1 publish, 1 reply, 1 send, 1 reply
    consumerActivation |> should equal 4 // 1 publish, 1 reply, 1 send, 1 reply
